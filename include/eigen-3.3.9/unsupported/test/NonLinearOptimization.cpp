...
void test_NonLinearOptimization()
{
    ...
    CALL_SUBtest/mine/*_1*/(testChkder());
    CALL_SUBtest/mine/*_1*/(testLmder1());
    CALL_SUBtest/mine/*_1*/(testLmder());
    CALL_SUBtest/mine/*_2*/(testHybrj1());
    CALL_SUBtest/mine/*_2*/(testHybrj());
    CALL_SUBtest/mine/*_2*/(testHybrd1());
    CALL_SUBtest/mine/*_2*/(testHybrd());
    CALL_SUBtest/mine/*_3*/(testLmstr1());
    CALL_SUBtest/mine/*_3*/(testLmstr());
    CALL_SUBtest/mine/*_3*/(testLmdif1());
    CALL_SUBtest/mine/*_3*/(testLmdif());

    // NIST tests, level of difficulty = "Lower"
    CALL_SUBtest/mine/*_4*/(testNistMisra1a());
    CALL_SUBtest/mine/*_4*/(testNistChwirut2());

    // NIST tests, level of difficulty = "Average"
    CALL_SUBtest/mine/*_5*/(testNistHahn1());
    CALL_SUBtest/mine/*_6*/(testNistMisra1d());
    CALL_SUBtest/mine/*_7*/(testNistMGH17());
    CALL_SUBtest/mine/*_8*/(testNistLanczos1());

//     // NIST tests, level of difficulty = "Higher"
    CALL_SUBtest/mine/*_9*/(testNistRat42());
//     CALL_SUBtest/mine/*_10*/(testNistMGH10());
    CALL_SUBtest/mine/*_11*/(testNistBoxBOD());
//     CALL_SUBtest/mine/*_12*/(testNistMGH09());
    CALL_SUBtest/mine/*_13*/(testNistBennett5());
    CALL_SUBtest/mine/*_14*/(testNistThurber());
    CALL_SUBtest/mine/*_15*/(testNistRat43());
    CALL_SUBtest/mine/*_16*/(testNistEckerle4());
}
